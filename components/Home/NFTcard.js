...
const style = {
  ...
  nftTitle: `text-sm font-bold text-gray-500 dark:text-gray-400`,
  priceContainer: `flex flex-col items-end justify-center space-y-1 text-gray-500 dark:text-gray-400`,
